...
![](/imgs/screenshot_20231209_220518.png)

且文件有一个“特殊”图标（[pyinstaller](https://github.com/pyinstaller/pyinstaller))
![](/imgs/screenshot_20231209_220630.png)

`strings` 命令可以看到 pyinstaller 相关的特征字符串：
![](/imgs/screenshot_20231209_220958.png)
...
可以看到这行中有一个命令类似 `flag` 的字符串，并且代码中也是 `reversed with`:
...
{{< figure src="/imgs/screenshot_20231209_222701.png" >}}
